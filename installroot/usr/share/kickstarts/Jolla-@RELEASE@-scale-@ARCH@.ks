# DisplayName: Jolla scale/@ARCH@ (release) 1
...
repo --name=adaptation-community-common-scale-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration scale
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/scale
